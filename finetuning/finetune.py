...
def train(
    ...
    assert (
        model_name
    ), "Please specify a --model_name, e.g. --model_name='huggyllama/llama-7b'"
    ...
    wandb_run_name = output_dir.split("/")[-1]
    ...
    # model.model_name.save_pretrained(output_dir)
