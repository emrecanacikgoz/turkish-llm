...
def train(
    ...
    # wandb params
    wandb_project: str = "llm-pretrain",
    wandb_run_name: str = "",
    ...
    if len(wandb_project) > 0:
        ...
        os.environ["WANDB_ENTITY"] = "kuisai"
    ...
    def generate_and_tokenize_prompt(data_point):
        if mode == "pretrain":
            prompt = prompter.generate_pretrain_data(data_point["text"])
    ...
    #TODO: if mode == "pretrain":
    #     data_collator = transformers.DataCollatorForLanguageModeling(tokenizer=tokenizer, mlm=False, padding=True)
    # elif mode == "sft":
    #     data_collator = transformers.DataCollatorForSeq2Seq(
    #         tokenizer, pad_to_multiple_of=8, return_tensors="pt", padding=True
    #     )
